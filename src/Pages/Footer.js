...
const Footer = () => {
    return (
        <div className='bg-[#111316]'>
            <div className='max-w-screen-xl mx-auto justify-center md:py-20 md:px-10 py-10'>
                <h1 className='text-[#aaa] md:text-base text-sm justify-center pb-5 px-5 '>
                    Website last updated: March 28, 2023
                </h1>
                <div className="py-2 md:px-0 px-3">
                    <a href="/">
                        <img src='./Black.png' className='md:w-52 w-52' alt='favicon.png'/>
                    </a>
                </div>
                <div className='md:grid md:grid-cols-3 gap-20 max-w-7xl mx-auto justify-center py-5 text-white px-7'>
                    <div className=''>
                    ...
                    <div className='md:pt-0 pt-10'>
                        ...
                        <p className='text-sm text-[#C3CDD3] md:pt-4 pt-2'>
                            Blackhorse Investment Trade P.O Box: 751, postal Code: 117 Sultanate of Oman
                        </p>
                    </div>
                    <div className='md:pt-0 pt-10'>
                        <h1 className='text-white text-base justify-center font-semibold'>
                ...
                <div className='justify-center mx-auto md:text-center px-5'>
                    ...
                    <p className='text-sm text-[#C3CDD3] md:pt-5 pt-5'>
                            Blackhorse Investment © 2023. All right reserved.
                    </p>
                </div>
            </div>
        </div>
